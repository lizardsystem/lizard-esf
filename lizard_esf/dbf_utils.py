...
class DBFExporter(object):
    ...
    def export_esf_configurations(self, owner, save_to, dbf_file, filename):
        ...
        if configurations.exists() == False:
            self.logger.debug('NO configurations for dbf_file %s' % dbf_file)
            return
    ...
    def field_to_dbf(self, out, f_name, f_type, f_length=None, f_decimals=None):
