...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AreaConfiguration.manual_value'
        db.delete_column('lizard_esf_areaconfiguration', 'manual_value')


    def backwards(self, orm):
        
        # Adding field 'AreaConfiguration.manual_value'
        db.add_column('lizard_esf_areaconfiguration', 'manual_value', self.gf('django.db.models.fields.DecimalField')(default=-999, max_digits=15, decimal_places=1), keep_default=False)
