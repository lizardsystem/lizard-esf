...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_esf_dbfconfiguration', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dbf_file', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_esf.DbfFile'])),
            ('data_set', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='esf_dbfconfiguration_set', null=True, to=orm['lizard_security.DataSet'])),
            ('save_to', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('filename', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('lizard_esf', ['DBFConfiguration'])

        # Changing field 'Configuration.dbf_valuefield_name'
        db.alter_column('lizard_esf_configuration', 'dbf_valuefield_name', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Configuration.dbf_manualfield_name'
        db.alter_column('lizard_esf_configuration', 'dbf_manualfield_name', self.gf('django.db.models.fields.CharField')(max_length=10))


    def backwards(self, orm):
        
        # Deleting model 'DBFConfiguration'
        db.delete_table('lizard_esf_dbfconfiguration')

        # Changing field 'Configuration.dbf_valuefield_name'
        db.alter_column('lizard_esf_configuration', 'dbf_valuefield_name', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Configuration.dbf_manualfield_name'
        db.alter_column('lizard_esf_configuration', 'dbf_manualfield_name', self.gf('django.db.models.fields.CharField')(max_length=128))
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 16, 15, 42, 53, 566684)'}),
