...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Configuration.base_config'
        db.add_column('lizard_esf_configuration', 'base_config', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_esf.Configuration'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Configuration.base_config'
        db.delete_column('lizard_esf_configuration', 'base_config_id')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 12, 16, 26, 49, 614672)'}),
