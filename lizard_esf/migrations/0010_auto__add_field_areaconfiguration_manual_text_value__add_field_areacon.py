...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AreaConfiguration.manual_text_value'
        db.add_column('lizard_esf_areaconfiguration', 'manual_text_value', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)

        # Adding field 'AreaConfiguration.fews_meta_info'
        db.add_column('lizard_esf_areaconfiguration', 'fews_meta_info', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AreaConfiguration.manual_text_value'
        db.delete_column('lizard_esf_areaconfiguration', 'manual_text_value')

        # Deleting field 'AreaConfiguration.fews_meta_info'
        db.delete_column('lizard_esf_areaconfiguration', 'fews_meta_info')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 3, 15, 15, 11, 40, 730141)'}),
