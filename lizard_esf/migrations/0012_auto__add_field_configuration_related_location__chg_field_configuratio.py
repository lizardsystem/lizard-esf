...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Configuration.related_location'
        db.add_column('lizard_esf_configuration', 'related_location', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)

        # Changing field 'Configuration.source_name'
        db.alter_column('lizard_esf_configuration', 'source_name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))


    def backwards(self, orm):
        
        # Deleting field 'Configuration.related_location'
        db.delete_column('lizard_esf_configuration', 'related_location')

        # Changing field 'Configuration.source_name'
        db.alter_column('lizard_esf_configuration', 'source_name', self.gf('django.db.models.fields.CharField')(default=datetime.date(2012, 4, 26), max_length=128))
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 26, 14, 38, 52, 365926)'}),
        ...
        'lizard_esf.areaconfiguration': {
            ...
            'manual_text_value': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'manual_value': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'})
        },
        'lizard_esf.configuration': {
            'Meta': {'object_name': 'Configuration'},
            'base_config': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lizard_esf.Configuration']", 'null': 'True', 'blank': 'True'}),
            ...
            'dbf_index': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            ...
            'dbf_valuefield_length': ('django.db.models.fields.IntegerField', [], {'default': '12', 'null': 'True', 'blank': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_main_esf': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
